...
*                                                                                                                    <br> File logging is only available on Windows x86/x64. 
...
*                                                                                                                    <br> Duty cycling period must be greater than integration time by at least 1 second.
...
* <tr> <td> "do_temperature_compensation"   <td> bool                 <td>           <td> false                      <td> Set if temperature compensation feature is enabled.
* <tr> <td> "power_mode"                    <td> bmv080_power_mode_t  <td>           <td> E_BMV080_POWER_MODE_1 (1)  <td> Selection of power mode based on the use case (bmv080_power_mode_t defined in bmv080_defs.h)
* </table>
*
* @pre A valid _handle_ generated by _bmv080_open_ is required.
*
...
*                                                                                                                    <br> Relative and absolute paths with both separators slash ( / ) or backslash ( \\ ) are supported.
*                                                                                                                    <br> A single dot ( . ) indicates the working directory and two dots ( .. ) the parent directory.
*                                                                                                                    <br> File logging is only available on Windows x86/x64.
*                                                                                                                    <br> This is applicable to all parameters with the suffix "_logging" in its name.
* <tr> <td> "pm_logging"                    <td> bool                 <td>           <td> false                      <td> Set if particulate matter output log files are created.
*                                                                                                                    <br> Disabled if _false_, enabled if _true_.
